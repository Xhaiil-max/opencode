...
import { Mic, MicOff, MonitorUp, Volume2, VolumeX, Eye, EyeOff, MoreVertical, EarOff, Video, VolumeX as MuteIcon, EarOff as DeafenIcon, VideoOff, Pin } from 'lucide-react'
import ParticipantVideo from './ParticipantVideo'
import AudioVisualizer, { WaveformDots } from './AudioVisualizer'
...
export default function ParticipantTile({ user, isCurrent, isDeafened, participant: participantProp, source, isLocalHost, muteParticipant, deafenParticipant, disableVideo, pinnedParticipantId, pinParticipant, unpinParticipant }: ParticipantTileProps) {
  ...
  useEffect(() => {
    if (!isScreenShare || !participant || pinnedParticipantId === user.id || !pinParticipant) return
